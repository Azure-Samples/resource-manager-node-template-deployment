...
var deploymentName = process.argv[3];
var resourceClient;
...
msRestAzure.loginWithServicePrincipalSecret(clientId, secret, domain, function (err, credentials) {
  ...
  deleteDeployment(function (err, result) {
    if (err) return console.log('Error occured in deleting the deployment: ' + deploymentName + '\n' + util.inspect(err, { depth: null }));
